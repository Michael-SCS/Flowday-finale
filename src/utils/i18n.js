...
const translations = {
  es: {
    ...
    auth: {
      ...
      errorEmailInvalid: '"¡Ups! Parece que el correo no es correcto. ¿Podrías revisarlo?"',
      errorPasswordInvalid: 'La contraseña debe tener al menos 8 caracteres.',
    ...
    profile: {
      ...
      deleteAccountMessage:
        'Si continúas, tus datos se eliminarán de forma permanente y cerrarás sesión. ¿Estás seguro de que quieres continuar?',
      ...
      privacyIntro:
        'Esta aplicación recopila y almacena únicamente la información mínima necesaria para ofrecerte una experiencia personalizada, como tu nombre, correo electrónico y algunos datos opcionales de perfil. No solicitamos información bancaria ni especialmente sensibles. Usamos estos datos únicamente para crear tu cuenta, autenticarte, mostrar tu información de perfil y personalizar algunas funciones. Tus datos se almacenan en servicios de terceros especializados y no se comparten con terceros con fines comerciales. Puedes solicitar la actualización o eliminación de tu perfil desde la app o contactando al soporte. Al registrarte confirmas que has leído esta información y aceptas el tratamiento de tus datos según lo descrito.',
    },
    premium: {
      title: 'Fluu PRO',
      subtitle:
...
'Oye, vemos que tienes un día muy atareado hoy. 😊 ¿Te gustaría eliminar alguna tarea para desocupar el día y respirar un poco?',      overloadDialogPrimary: 'Sí, ayudarme a reordenar',
      ...
      // timeConflictMessage: 'Ya tienes otra actividad en este horario. Ajusta la hora o la duración.',
  ...
  en: {
          fr: {
            creativeHobbyOptions: [
              ...
              'Journal créatif (journaux visuels)',
              'Macramé décoratif',
              'Pâtisserie créative',
    ...
    auth: {
      ...
      errorEmailInvalid: 'Oops! It looks like the email isn\'t correct. Could you check it?',
      errorPasswordInvalid: 'The password must be at least 8 characters.',
    ...
    profile: {
      ...
      deleteAccountMessage:
        'If you continue, your data will be permanently deleted and you will be signed out. Are you sure you want to proceed?',
    ...
    calendar: {
      ...
      overloadDialogMessage:
        'Hey, we see you have a really busy day today. 😊 Would you like to remove any tasks to free up your day and breathe a little?',
      overloadDialogPrimary: 'Yes, help me',
  ...
  pt: {
    ...
    auth: {
      ...
      errorEmailInvalid: 'Ops! Parece que o e-mail não está correto. Você poderia verificá-lo?',
      errorPasswordInvalid: 'A senha deve ter pelo menos 8 caracteres.',
    ...
    profile: {
      ...
      deleteAccountMessage:
        'Se você continuar, seus dados serão excluídos permanentemente e você sairá da conta. Tem certeza de que deseja continuar?',
    ...
    calendar: {
      ...
      overloadDialogMessage:
        'Ei, vemos que você tem um dia bem ocupado hoje. 😊 Gostaria de remover alguma tarefa para desafogar o dia e respirar um pouco?',
      ...
      vitaminsDefaultSectionTitle: 'Vitaminas',
      checklistDefaultTitle: 'Checklist',
      checklistDefaultSectionTitle: 'Espaços a organizar',
    ...
    habitForm: {
      ...
      weeklyErrorMessage: 'Selecione pelo menos um dia de la semana',
  ...
  fr: {
    ...
    auth: {
      ...
      errorEmailInvalid: "Oups ! Il semblerait que l'e-mail ne soit pas correct. Pourrais-tu le vérifier ?",
      errorPasswordInvalid: 'Le mot de passe doit avoir au moins 8 caractères.',
    ...
    register: {
      ...
      legalBullet2: 'Préciser que vous ne fournissez pas de conseils médicaux ou financiers.',
    ...
    profile: {
      ...
      deleteAccountMessage:
        'Si tu continues, tes données seront définitivement supprimées et tu seras déconnecté. Es-tu sûr de vouloir continuer ?',
      ...
      privacyUseOfDataText: 'Vos données sont stockées dans des services tiers spécialisés et ne sont utilisées que pour :',
      privacyUseOfDataBullet1: 'Gérer votre compte et votre authentification',
      privacyUseOfDataBullet2: 'Afficher et personnaliser vos informations de profil',
      privacyUseOfDataBullet3: "Améliorer et maintenir les fonctionnalités de l'application",
      privacySharingTitle: 'Partage des informations',
      privacySharingText: "Nous ne partageons pas vos informations personnelles avec des tiers à des fins commerciales. Nous ne pourrions partager des données qu'en cas d'obligation légale, de demande d'une autorité compétente, ou pour protéger la sécurité et l'intégrité du service et des autres utilisateurs.",
