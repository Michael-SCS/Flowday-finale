...
const translations = {
  es: {
    ...
    calendar: {
      ...
      total: 'Total:',
      accept: 'Aceptar',
      waterGoalReached: '¡Meta de agua alcanzada! ¡Bien hecho! 💧',
      waterAlmostThere: '¡Casi logras tu meta de agua, sigue así!',
      waterDoingGreat: '¡Vas muy bien, sigue hidratándote!',
      waterGoodStart: '¡Buen comienzo! Sigue tomando agua.',
      waterStartGlass: 'Toma tu primer vaso de agua hoy.',
      progressLabel: 'Progreso de agua',
      addWater: 'Agregar agua (ml)',
  ...
  en: {
    ...
    calendar: {
      ...
      total: 'Total:',
      accept: 'Done',
      waterGoalReached: 'Water goal reached! Well done! 💧',
      waterAlmostThere: 'Almost at your water goal, keep going!',
      waterDoingGreat: 'You are doing great, stay hydrated!',
      waterGoodStart: 'Good start! Keep drinking water.',
      waterStartGlass: 'Have your first glass of water today.',
    },
    habitForm: {
      periodLabel: '📅 Period',
      startLabel: 'Start',
  ...
  pt: {
    ...
    calendar: {
      ...
      keepSameTime: 'Manter a mesma hora',
  ...
  fr: {
    ...
    mood: {
      ...
      messages: {
        1: [
          ...
          'Ralentissez si vous en avez besoin. Continuez doucement.',
          'Une minute à la fois. Vous pouvez gérer ce moment.',
          'Demandez du soutien si besoin. Vous le méritez.',
        ],
        2: [
          "Ce n'est pas votre meilleur jour, mais vous pouvez encore prendre soin de vous.",
          ...
          'Les petites victoires comptent. Choisissez-en une et allez-y.',
          "Votre humeur peut changer. Accordez-vous de l'espace et de la patience.",
        ],
        3: [
          ...
          'Planifiez avec soin : moins c\'est plus.',
          'La constance l\'emporte sur la perfection.',
          "Aujourd'hui, avancez sans pression.",
        ],
        4: [
          "Bonne énergie ! Profitez-en pour terminer de petites tâches.",
          'Vous allez bien. Restez concentré(e) et célébrez vos progrès.',
          'Utilisez cette énergie pour un objectif significatif.',
          'Journée parfaite pour construire des habitudes douces et constantes.',
          'Continuez ainsi : pas réguliers et esprit calme.',
          'Partagez votre bonne énergie : la gentillesse multiplie.',
        ],
        5: [
          "Incroyable ! Visez un grand objectif aujourd'hui.",
          "Cette énergie est précieuse. Investissez-la dans ce qui compte le plus.",
          'Vous êtes en pleine forme : créez, décidez, avancez.',
          'Vous brillez. N\'oubliez pas de vous hydrater et de respirer aussi.',
          'Profitez de l\'élan : terminez quelque chose que vous aviez remis à plus tard.',
          'Journée au top. Célébrez chaque victoire, même les petites.',
        ],
      },
    },
    profile: {
    ...
    premium: {
      ...
      statsDescription:
        'Séries claires, % de réussite hebdomadaire et mensuelle, et le meilleur moment de la journée pour compléter vos habitudes.',
